...
RUN_SCRIPT="$SCRIPT_DIR/eval_baseline_with_tools.sh"
OUTPUT_DIR="${OUTPUT_DIR:-$PROJECT_DIR/eval/output/baseline_with_tools}"

LOG_DIR="${LOG_DIR:-$OUTPUT_DIR}"
PID_FILE="${PID_FILE:-$OUTPUT_DIR/eval_baseline_with_tools.pid}"
LOG_FILE="${LOG_FILE:-$OUTPUT_DIR/eval_baseline_with_tools.log}"
